    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView horizontal={true}>
                {places.map(p => (
                     <Places key={p.id} direction="H" info={p}/>
                ))}
